 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const si=(t,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(n){n.createProperty(e.key,t)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(n){n.createProperty(e.key,t)}},ai=(t,e,n)=>{e.constructor.createProperty(n,t)};function E(t){return(e,n)=>n!==void 0?ai(t,e,n):si(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */var Je=typeof navigator<"u"?navigator.userAgent.toLowerCase().indexOf("firefox")>0:!1;function qe(t,e,n){t.addEventListener?t.addEventListener(e,n,!1):t.attachEvent&&t.attachEvent("on".concat(e),function(){n(window.event)})}function sn(t,e){for(var n=e.slice(0,e.length-1),i=0;i<n.length;i++)n[i]=t[n[i].toLowerCase()];return n}function an(t){typeof t!="string"&&(t=""),t=t.replace(/\s/g,"");for(var e=t.split(","),n=e.lastIndexOf("");n>=0;)e[n-1]+=",",e.splice(n,1),n=e.lastIndexOf("");return e}function Ai(t,e){for(var n=t.length>=e.length?t:e,i=t.length>=e.length?e:t,o=!0,s=0;s<n.length;s++)i.indexOf(n[s])===-1&&(o=!1);return o}var ln={backspace:8,tab:9,clear:12,enter:13,return:13,esc:27,escape:27,space:32,left:37,up:38,right:39,down:40,del:46,delete:46,ins:45,insert:45,home:36,end:35,pageup:33,pagedown:34,capslock:20,num_0:96,num_1:97,num_2:98,num_3:99,num_4:100,num_5:101,num_6:102,num_7:103,num_8:104,num_9:105,num_multiply:106,num_add:107,num_enter:108,num_subtract:109,num_decimal:110,num_divide:111,"⇪":20,",":188,".":190,"/":191,"`":192,"-":Je?173:189,"=":Je?61:187,";":Je?59:186,"'":222,"[":219,"]":221,"\\":220},q={"⇧":16,shift:16,"⌥":18,alt:18,option:18,"⌃":17,ctrl:17,control:17,"⌘":91,cmd:91,command:91},Rt={16:"shiftKey",18:"altKey",17:"ctrlKey",91:"metaKey",shiftKey:16,ctrlKey:17,altKey:18,metaKey:91},T={16:!1,18:!1,17:!1,91:!1},w={};for(var Se=1;Se<20;Se++)ln["f".concat(Se)]=111+Se;var m=[],rn="all",cn=[],Re=function(e){return ln[e.toLowerCase()]||q[e.toLowerCase()]||e.toUpperCase().charCodeAt(0)};function hn(t){rn=t||"all"}function fe(){return rn||"all"}function Oi(){return m.slice(0)}function gi(t){var e=t.target||t.srcElement,n=e.tagName,i=!0;return(e.isContentEditable||(n==="INPUT"||n==="TEXTAREA"||n==="SELECT")&&!e.readOnly)&&(i=!1),i}function mi(t){return typeof t=="string"&&(t=Re(t)),m.indexOf(t)!==-1}function Ni(t,e){var n,i;t||(t=fe());for(var o in w)if(Object.prototype.hasOwnProperty.call(w,o))for(n=w[o],i=0;i<n.length;)n[i].scope===t?n.splice(i,1):i++;fe()===t&&hn(e||"all")}function Ci(t){var e=t.keyCode||t.which||t.charCode,n=m.indexOf(e);if(n>=0&&m.splice(n,1),t.key&&t.key.toLowerCase()==="meta"&&m.splice(0,m.length),(e===93||e===224)&&(e=91),e in T){T[e]=!1;for(var i in q)q[i]===e&&(S[i]=!1)}}function Si(t){if(!t)Object.keys(w).forEach(function(a){return delete w[a]});else if(Array.isArray(t))t.forEach(function(a){a.key&&Qe(a)});else if(typeof t=="object")t.key&&Qe(t);else if(typeof t=="string"){for(var e=arguments.length,n=new Array(e>1?e-1:0),i=1;i<e;i++)n[i-1]=arguments[i];var o=n[0],s=n[1];typeof o=="function"&&(s=o,o=""),Qe({key:t,scope:o,method:s,splitKey:"+"})}}var Qe=function(e){var n=e.key,i=e.scope,o=e.method,s=e.splitKey,a=s===void 0?"+":s,l=an(n);l.forEach(function(r){var c=r.split(a),d=c.length,p=c[d-1],h=p==="*"?"*":Re(p);if(w[h]){i||(i=fe());var v=d>1?sn(q,c):[];w[h]=w[h].map(function(u){var _=o?u.method===o:!0;return _&&u.scope===i&&Ai(u.mods,v)?{}:u})}})};function $t(t,e,n){var i;if(e.scope===n||e.scope==="all"){i=e.mods.length>0;for(var o in T)Object.prototype.hasOwnProperty.call(T,o)&&(!T[o]&&e.mods.indexOf(+o)>-1||T[o]&&e.mods.indexOf(+o)===-1)&&(i=!1);(e.mods.length===0&&!T[16]&&!T[18]&&!T[17]&&!T[91]||i||e.shortcut==="*")&&e.method(t,e)===!1&&(t.preventDefault?t.preventDefault():t.returnValue=!1,t.stopPropagation&&t.stopPropagation(),t.cancelBubble&&(t.cancelBubble=!0))}}function xt(t){var e=w["*"],n=t.keyCode||t.which||t.charCode;if(S.filter.call(this,t)){if((n===93||n===224)&&(n=91),m.indexOf(n)===-1&&n!==229&&m.push(n),["ctrlKey","altKey","shiftKey","metaKey"].forEach(function(v){var u=Rt[v];t[v]&&m.indexOf(u)===-1?m.push(u):!t[v]&&m.indexOf(u)>-1?m.splice(m.indexOf(u),1):v==="metaKey"&&t[v]&&m.length===3&&(t.ctrlKey||t.shiftKey||t.altKey||(m=m.slice(m.indexOf(u))))}),n in T){T[n]=!0;for(var i in q)q[i]===n&&(S[i]=!0);if(!e)return}for(var o in T)Object.prototype.hasOwnProperty.call(T,o)&&(T[o]=t[Rt[o]]);t.getModifierState&&!(t.altKey&&!t.ctrlKey)&&t.getModifierState("AltGraph")&&(m.indexOf(17)===-1&&m.push(17),m.indexOf(18)===-1&&m.push(18),T[17]=!0,T[18]=!0);var s=fe();if(e)for(var a=0;a<e.length;a++)e[a].scope===s&&(t.type==="keydown"&&e[a].keydown||t.type==="keyup"&&e[a].keyup)&&$t(t,e[a],s);if(n in w){for(var l=0;l<w[n].length;l++)if((t.type==="keydown"&&w[n][l].keydown||t.type==="keyup"&&w[n][l].keyup)&&w[n][l].key){for(var r=w[n][l],c=r.splitKey,d=r.key.split(c),p=[],h=0;h<d.length;h++)p.push(Re(d[h]));p.sort().join("")===m.sort().join("")&&$t(t,r,s)}}}}function Mi(t){return cn.indexOf(t)>-1}function S(t,e,n){m=[];var i=an(t),o=[],s="all",a=document,l=0,r=!1,c=!0,d="+";for(n===void 0&&typeof e=="function"&&(n=e),Object.prototype.toString.call(e)==="[object Object]"&&(e.scope&&(s=e.scope),e.element&&(a=e.element),e.keyup&&(r=e.keyup),e.keydown!==void 0&&(c=e.keydown),typeof e.splitKey=="string"&&(d=e.splitKey)),typeof e=="string"&&(s=e);l<i.length;l++)t=i[l].split(d),o=[],t.length>1&&(o=sn(q,t)),t=t[t.length-1],t=t==="*"?"*":Re(t),t in w||(w[t]=[]),w[t].push({keyup:r,keydown:c,scope:s,mods:o,shortcut:i[l],method:n,key:i[l],splitKey:d});typeof a<"u"&&!Mi(a)&&window&&(cn.push(a),qe(a,"keydown",function(p){xt(p)}),qe(window,"focus",function(){m=[]}),qe(a,"keyup",function(p){xt(p),Ci(p)}))}var et={setScope:hn,getScope:fe,deleteScope:Ni,getPressedKeyCodes:Oi,isPressed:mi,filter:gi,unbind:Si};for(var tt in et)Object.prototype.hasOwnProperty.call(et,tt)&&(S[tt]=et[tt]);if(typeof window<"u"){var Ei=window.hotkeys;S.noConflict=function(t){return t&&window.hotkeys===S&&(window.hotkeys=Ei),S},window.hotkeys=S}var Oe=function(t,e,n,i){var o=arguments.length,s=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,n):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(t,e,n,i);else for(var l=t.length-1;l>=0;l--)(a=t[l])&&(s=(o<3?a(s):o>3?a(e,n,s):a(e,n))||s);return o>3&&s&&Object.defineProperty(e,n,s),s};let Q=class extends z{constructor(){super(...arguments),this.placeholder="",this.hideBreadcrumbs=!1,this.breadcrumbHome="Home",this.breadcrumbs=[],this._inputRef=nn()}render(){let e="";if(!this.hideBreadcrumbs){const n=[];for(const i of this.breadcrumbs)n.push(y`<button
            tabindex="-1"
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class lt extends Ae{constructor(e){if(super(e),this.et=N,e.type!==H.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===N||e==null)return this.ft=void 0,this.et=e;if(e===j)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const n=[e];return n.raw=n,this.ft={_$litType$:this.constructor.resultType,strings:n,values:[]}}}lt.directiveName="unsafeHTML",lt.resultType=1;const wi=_e(lt);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*Ti(t,e){if(t!==void 0){let n=-1;for(const i of t)n>-1&&(yield e),n++,yield i}}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-LIcense-Identifier: Apache-2.0
 */const yi=ye`:host{font-family:var(--mdc-icon-font, "Material Icons");font-weight:normal;font-style:normal;font-size:var(--mdc-icon-size, 24px);line-height:1;letter-spacing:normal;text-transform:none;display:inline-block;white-space:nowrap;word-wrap:normal;direction:ltr;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility;-moz-osx-font-smoothing:grayscale;font-feature-settings:"liga"}`;/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */let rt=class extends z{render(){return y`<span><slot></slot></span>`}};rt.styles=[yi];rt=_n([be("mwc-icon")],rt);var $e=function(t,e,n,i){var o=arguments.length,s=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,n):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(t,e,n,i);else for(var l=t.length-1;l>=0;l--)(a=t[l])&&(s=(o<3?a(s):o>3?a(e,n,s):a(e,n))||s);return o>3&&s&&Object.defineProperty(e,n,s),s};let oe=class extends z{constructor(){super(),this.selected=!1,this.hotKeysJoinedView=!0,this.addEventListener("click",this.click)}ensureInView(){requestAnimationFrame(()=>this.scrollIntoView({block:"nearest"}))}click(){this.dispatchEvent(new CustomEvent("actionsSelected",{detail:this.action,bubbles:!0,composed:!0}))}updated(e){e.has("selected")&&this.selected&&this.ensureInView()}render(){let e;this.action.mdIcon?e=y`<mwc-icon part="ninja-icon" class="ninja-icon"
        >${this.action.mdIcon}</mwc-icon
      >`:this.action.icon&&(e=wi(this.action.icon||""));let n;this.action.hotkey&&(this.hotKeysJoinedView?n=this.action.hotkey.split(",").map(o=>{const s=o.split("+"),a=y`${Ti(s.map(l=>y`<kbd>${l}</kbd>`),"+")}`;return y`<div class="ninja-hotkey ninja-hotkeys">
            ${a}
  ...
  `;$e([E({type:Object})],oe.prototype,"action",void 0);$e([E({type:Boolean})],oe.prototype,"selected",void 0);$e([E({type:Boolean})],oe.prototype,"hotKeysJoinedView",void 0);oe=$e([be("ninja-action")],oe);const Ii=y` <div class="modal-footer" slot="footer">
  <span class="help">
    <svg
      version="1.0"
...
`,Wi=`<svg role="img" class="ninja-icon ninja-icon--fluent" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`,de='<svg role="img" class="ninja-icon ninja-icon--fluent" width="18" height="18" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m13.314 7.565l-.136.126l-10.48 10.488a2.27 2.27 0 0 0 3.211 3.208L16.388 10.9a2.251 2.251 0 0 0-.001-3.182l-.157-.146a2.25 2.25 0 0 0-2.916-.007Zm-.848 2.961l1.088 1.088l-8.706 8.713a.77.77 0 1 1-1.089-1.088l8.707-8.713Zm4.386 4.48L16.75 15a.75.75 0 0 0-.743.648L16 15.75v.75h-.75a.75.75 0 0 0-.743.648l-.007.102c0 .38.282.694.648.743l.102.007H16v.75c0 .38.282.694.648.743l.102.007a.75.75 0 0 0 .743-.648l.007-.102V18h.75a.75.75 0 0 0 .743-.648L19 17.25a.75.75 0 0 0-.648-.743l-.102-.007h-.75v-.75a.75.75 0 0 0-.648-.743L16.75 15l.102.007Zm-1.553-6.254l.027.027a.751.751 0 0 1 0 1.061l-.711.713l-1.089-1.089l.73-.73a.75.75 0 0 1 1.043.018ZM6.852 5.007L6.75 5a.75.75 0 0 0-.743.648L6 5.75v.75h-.75a.75.75 0 0 0-.743.648L4.5 7.25c0 .38.282.693.648.743L5.25 8H6v.75c0 .38.282.693.648.743l.102.007a.75.75 0 0 0 .743-.648L7.5 8.75V8h.75a.75.75 0 0 0 .743-.648L9 7.25a.75.75 0 0 0-.648-.743L8.25 6.5H7.5v-.75a.75.75 0 0 0-.648-.743L6.75 5l.102.007Zm12-2L18.75 3a.75.75 0 0 0-.743.648L18 3.75v.75h-.75a.75.75 0 0 0-.743.648l-.007.102c0 .38.282.693.648.743L17.25 6H18v.75c0 .38.282.693.648.743l.102.007a.75.75 0 0 0 .743-.648l.007-.102V6h.75a.75.75 0 0 0 .743-.648L21 5.25a.75.75 0 0 0-.648-.743L20.25 4.5h-.75v-.75a.75.75 0 0 0-.648-.743L18.75 3l.102.007Z" fill="currentColor"/></svg>',Qi='<svg role="img" class="ninja-icon ninja-icon--fluent" width="18" height="18" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M4 4.5A2.5 2.5 0 0 1 6.5 2H18a2.5 2.5 0 0 1 2.5 2.5v14.25a.75.75 0 0 1-.75.75H5.5a1 1 0 0 0 1 1h13.25a.75.75 0 0 1 0 1.5H6.5A2.5 2.5 0 0 1 4 19.5v-15ZM5.5 18H19V4.5a1 1 0 0 0-1-1H6.5a1 1 0 0 0-1 1V18Z" fill="currentColor"/></svg>',e1='<svg role="img" class="ninja-icon ninja-icon--fluent" width="18" height="18" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M6.75 19.5h14.5a.75.75 0 0 0 .102-1.493L21.25 18H6.75a.75.75 0 0 0-.102 1.493l.102.007Zm0-15h14.5a.75.75 0 0 0 .102-1.493L21.25 3H6.75a.75.75 0 0 0-.102 1.493l.102.007Zm7 3.5a.75.75 0 0 0 0 1.5h7.5a.75.75 0 0 0 0-1.5h-7.5ZM13 13.75a.75.75 0 0 1 .75-.75h7.5a.75.75 0 0 1 0 1.5h-7.5a.75.75 0 0 1-.75-.75Zm-2-2.25a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0Zm-4-2a.5.5 0 0 0-1 0V11H4.5a.5.5 0 0 0 0 1H6v1.5a.5.5 0 0 0 1 0V12h1.5a.5.5 0 0 0 0-1H7V9.5Z" fill="currentColor"/></svg>',t1='<svg role="img" class="ninja-icon ninja-icon--fluent" width="18" height="18" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M6.75 4.5h14.5a.75.75 0 0 0 .102-1.493L21.25 3H6.75a.75.75 0 0 0-.102 1.493l.102.007Zm0 15h14.5a.75.75 0 0 0 .102-1.493L21.25 18H6.75a.75.75 0 0 0-.102 1.493l.102.007Zm7-11.5a.75.75 0 0 0 0 1.5h7.5a.75.75 0 0 0 0-1.5h-7.5ZM13 13.75a.75.75 0 0 1 .75-.75h7.5a.75.75 0 0 1 0 1.5h-7.5a.75.75 0 0 1-.75-.75Zm-2-2.25a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0Zm-2 0a.5.5 0 0 0-.5-.5h-4a.5.5 0 0 0 0 1h4a.5.5 0 0 0 .5-.5Z" fill="currentColor"/></svg>',n1='<svg role="img" class="ninja-icon ninja-icon--fluent" width="18" height="18" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M3 17h7.522l-2 2H3a1 1 0 0 1-.117-1.993L3 17Zm0-2h7.848a1.75 1.75 0 0 1-.775-2H3l-.117.007A1 1 0 0 0 3 15Zm0-8h18l.117-.007A1 1 0 0 0 21 5H3l-.117.007A1 1 0 0 0 3 7Zm9.72 9.216a.75.75 0 1 1 1.06 1.06l-4.5 4.5a.75.75 0 1 1-1.06-1.06l4.5-4.5ZM3 9h10a1 1 0 0 1 .117 1.993L13 11H3a1 1 0 0 1-.117-1.993L3 9Zm13.5-1a.75.75 0 0 1 .744.658l.14 1.13a3.25 3.25 0 0 0 2.828 2.829l1.13.139a.75.75 0 0 1 0 1.488l-1.13.14a3.25 3.25 0 0 0-2.829 2.828l-.139 1.13a.75.75 0 0 1-1.488 0l-.14-1.13a3.25 3.25 0 0 0-2.828-2.829l-1.13-.139a.75.75 0 0 1 0-1.488l1.13-.14a3.25 3.25 0 0 0 2.829-2.828l.139-1.13A.75.75 0 0 1 16.5 8Z" fill="currentColor"/></svg>',i1='<svg role="img" class="ninja-icon ninja-icon--fluent" xmlns="http://www.w3.org/2000/svg" width="18" height="18"viewBox="0 0 24 24"><path fill="currentColor" d="M3.839 5.858c2.94-3.916 9.03-5.055 13.364-2.36c4.28 2.66 5.854 7.777 4.1 12.577c-1.655 4.533-6.016 6.328-9.159 4.048c-1.177-.854-1.634-1.925-1.854-3.664l-.106-.987l-.045-.398c-.123-.934-.311-1.352-.705-1.572c-.535-.298-.892-.305-1.595-.033l-.351.146l-.179.078c-1.014.44-1.688.595-2.541.416l-.2-.047l-.164-.047c-2.789-.864-3.202-4.647-.565-8.157Zm.984 6.716l.123.037l.134.03c.439.087.814.015 1.437-.242l.602-.257c1.202-.493 1.985-.54 3.046.05c.917.512 1.275 1.298 1.457 2.66l.053.459l.055.532l.047.422c.172 1.361.485 2.09 1.248 2.644c2.275 1.65 5.534.309 6.87-3.349c1.516-4.152.174-8.514-3.484-10.789c-3.675-2.284-8.899-1.306-11.373 1.987c-2.075 2.763-1.82 5.28-.215 5.816Zm11.225-1.994a1.25 1.25 0 1 1 2.414-.647a1.25 1.25 0 0 1-2.414.647Zm.494 3.488a1.25 1.25 0 1 1 2.415-.647a1.25 1.25 0 0 1-2.415.647ZM14.07 7.577a1.25 1.25 0 1 1 2.415-.647a1.25 1.25 0 0 1-2.415.647Zm-.028 8.998a1.25 1.25 0 1 1 2.414-.647a1.25 1.25 0 0 1-2.414.647Zm-3.497-9.97a1.25 1.25 0 1 1 2.415-.646a1.25 1.25 0 0 1-2.415.646Z"/></svg>',o1='<svg role="img" class="ninja-icon ninja-icon--fluent" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><path fill="currentColor" d="M12 2a.75.75 0 0 1 .75.75v1.5a.75.75 0 0 1-1.5 0v-1.5A.75.75 0 0 1 12 2Zm5 10a5 5 0 1 1-10 0a5 5 0 0 1 10 0Zm4.25.75a.75.75 0 0 0 0-1.5h-1.5a.75.75 0 0 0 0 1.5h1.5ZM12 19a.75.75 0 0 1 .75.75v1.5a.75.75 0 0 1-1.5 0v-1.5A.75.75 0 0 1 12 19Zm-7.75-6.25a.75.75 0 0 0 0-1.5h-1.5a.75.75 0 0 0 0 1.5h1.5Zm-.03-8.53a.75.75 0 0 1 1.06 0l1.5 1.5a.75.75 0 0 1-1.06 1.06l-1.5-1.5a.75.75 0 0 1 0-1.06Zm1.06 15.56a.75.75 0 1 1-1.06-1.06l1.5-1.5a.75.75 0 1 1 1.06 1.06l-1.5 1.5Zm14.5-15.56a.75.75 0 0 0-1.06 0l-1.5 1.5a.75.75 0 0 0 1.06 1.06l1.5-1.5a.75.75 0 0 0 0-1.06Zm-1.06 15.56a.75.75 0 1 0 1.06-1.06l-1.5-1.5a.75.75 0 1 0-1.06 1.06l1.5 1.5Z"/></svg>',s1='<svg role="img" class="ninja-icon ninja-icon--fluent" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><path fill="currentColor" d="M20.026 17.001c-2.762 4.784-8.879 6.423-13.663 3.661A9.965 9.965 0 0 1 3.13 17.68a.75.75 0 0 1 .365-1.132c3.767-1.348 5.785-2.91 6.956-5.146c1.232-2.353 1.551-4.93.689-8.463a.75.75 0 0 1 .769-.927a9.961 9.961 0 0 1 4.457 1.327c4.784 2.762 6.423 8.879 3.66 13.662Zm-8.248-4.903c-1.25 2.389-3.31 4.1-6.817 5.499a8.49 8.49 0 0 0 2.152 1.766a8.502 8.502 0 0 0 8.502-14.725a8.484 8.484 0 0 0-2.792-1.015c.647 3.384.23 6.043-1.045 8.475Z"/></svg>',a1='<svg role="img" class="ninja-icon ninja-icon--fluent" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><path fill="currentColor" d="M4.25 3A2.25 2.25 0 0 0 2 5.25v10.5A2.25 2.25 0 0 0 4.25 18H9.5v1.25c0 .69-.56 1.25-1.25 1.25h-.5a.75.75 0 0 0 0 1.5h8.5a.75.75 0 0 0 0-1.5h-.5c-.69 0-1.25-.56-1.25-1.25V18h5.25A2.25 2.25 0 0 0 22 15.75V5.25A2.25 2.25 0 0 0 19.75 3H4.25ZM13 18v1.25c0 .45.108.875.3 1.25h-2.6c.192-.375.3-.8.3-1.25V18h2ZM3.5 5.25a.75.75 0 0 1 .75-.75h15.5a.75.75 0 0 1 .75.75V13h-17V5.25Zm0 9.25h17v1.25a.75.75 0 0 1-.75.75H4.25a.75.75 0 0 1-.75-.75V14.5Z"/></svg>',ee='<svg role="img" class="ninja-icon ninja-icon--fluent" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><path fill="currentColor" d="M12 3.5c-3.104 0-6 2.432-6 6.25v4.153L4.682 17h14.67l-1.354-3.093V11.75a.75.75 0 0 1 1.5 0v1.843l1.381 3.156a1.25 1.25 0 0 1-1.145 1.751H15a3.002 3.002 0 0 1-6.003 0H4.305a1.25 1.25 0 0 1-1.15-1.739l1.344-3.164V9.75C4.5 5.068 8.103 2 12 2c.86 0 1.705.15 2.5.432a.75.75 0 0 1-.502 1.413A5.964 5.964 0 0 0 12 3.5ZM12 20c.828 0 1.5-.671 1.501-1.5h-3.003c0 .829.673 1.5 1.502 1.5Zm3.25-13h-2.5l-.101.007A.75.75 0 0 0 12.75 8.5h1.043l-1.653 2.314l-.055.09A.75.75 0 0 0 12.75 12h2.5l.102-.007a.75.75 0 0 0-.102-1.493h-1.042l1.653-2.314l.055-.09A.75.75 0 0 0 15.25 7Zm6-5h-3.5l-.101.007A.75.75 0 0 0 17.75 3.5h2.134l-2.766 4.347l-.05.09A.75.75 0 0 0 17.75 9h3.5l.102-.007A.75.75 0 0 0 21.25 7.5h-2.133l2.766-4.347l.05-.09A.75.75 0 0 0 21.25 2Z"/></svg>',l1=t=>[{key:"light",label:t("COMMAND_BAR.COMMANDS.LIGHT_MODE"),icon:o1},{key:"dark",label:t("COMMAND_BAR.COMMANDS.DARK_MODE"),icon:s1},{key:"auto",label:t("COMMAND_BAR.COMMANDS.SYSTEM_MODE"),icon:a1}],r1=t=>{An.set(On.COLOR_SCHEME,t);const e=window.matchMedia("(prefers-color-scheme: dark)").matches;gn(e)};function c1(){const{t}=se(),e=O(()=>l1(t));return{goToAppearanceHotKeys:O(()=>{const i=e.value.map(o=>({id:o.key,title:o.label,parent:"appearance_settings",section:t("COMMAND_BAR.SECTIONS.APPEARANCE"),icon:o.icon,handler:()=>{r1(o.key)}}));return[{id:"appearance_settings",title:t("COMMAND_BAR.COMMANDS.CHANGE_APPEARANCE"),section:t("COMMAND_BAR.SECTIONS.APPEARANCE"),icon:i1,children:i.map(o=>o.id)},...i]})}}const B=U.SNOOZE_OPTIONS,ce=t=>()=>P.emit(Ut,t),h1=[{id:"snooze_notification",title:"COMMAND_BAR.COMMANDS.SNOOZE_NOTIFICATION",icon:ee,children:Object.values(B)},{id:B.AN_HOUR_FROM_NOW,title:"COMMAND_BAR.COMMANDS.AN_HOUR_FROM_NOW",parent:"snooze_notification",section:"COMMAND_BAR.SECTIONS.SNOOZE_NOTIFICATION",icon:ee,handler:ce(B.AN_HOUR_FROM_NOW)},{id:B.UNTIL_TOMORROW,title:"COMMAND_BAR.COMMANDS.UNTIL_TOMORROW",section:"COMMAND_BAR.SECTIONS.SNOOZE_NOTIFICATION",parent:"snooze_notification",icon:ee,handler:ce(B.UNTIL_TOMORROW)},{id:B.UNTIL_NEXT_WEEK,title:"COMMAND_BAR.COMMANDS.UNTIL_NEXT_WEEK",section:"COMMAND_BAR.SECTIONS.SNOOZE_NOTIFICATION",parent:"snooze_notification",icon:ee,handler:ce(B.UNTIL_NEXT_WEEK)},{id:B.UNTIL_NEXT_MONTH,title:"COMMAND_BAR.COMMANDS.UNTIL_NEXT_MONTH",section:"COMMAND_BAR.SECTIONS.SNOOZE_NOTIFICATION",parent:"snooze_notification",icon:ee,handler:ce(B.UNTIL_NEXT_MONTH)},{id:B.UNTIL_CUSTOM_TIME,title:"COMMAND_BAR.COMMANDS.UNTIL_CUSTOM_TIME",section:"COMMAND_BAR.SECTIONS.SNOOZE_NOTIFICATION",parent:"snooze_notification",icon:ee,handler:ce(B.UNTIL_CUSTOM_TIME)}];function d1(){const{t}=se(),e=Zt(),n=o=>o.map(s=>({...s,title:t(s.title),section:s.section?t(s.section):void 0}));return{inboxHotKeys:O(()=>Vt(e.name)?n(h1):[])}}const u1=[{id:"goto_conversation_dashboard",title:"COMMAND_BAR.COMMANDS.GO_TO_CONVERSATION_DASHBOARD",section:"COMMAND_BAR.SECTIONS.GENERAL",icon:Li,path:t=>`accounts/${t}/dashboard`,role:["administrator","agent"]},{id:"goto_contacts_dashboard",title:"COMMAND_BAR.COMMANDS.GO_TO_CONTACTS_DASHBOARD",section:"COMMAND_BAR.SECTIONS.GENERAL",featureFlag:L.CRM,icon:ji,path:t=>`accounts/${t}/contacts`,role:["administrator","agent"]},{id:"open_reports_overview",section:"COMMAND_BAR.SECTIONS.REPORTS",title:"COMMAND_BAR.COMMANDS.GO_TO_REPORTS_OVERVIEW",featureFlag:L.REPORTS,icon:ki,path:t=>`accounts/${t}/reports/overview`,role:["administrator"]},{id:"open_conversation_reports",section:"COMMAND_BAR.SECTIONS.REPORTS",title:"COMMAND_BAR.COMMANDS.GO_TO_CONVERSATION_REPORTS",featureFlag:L.REPORTS,icon:Di,path:t=>`accounts/${t}/reports/conversation`,role:["administrator"]},{id:"open_agent_reports",section:"COMMAND_BAR.SECTIONS.REPORTS",title:"COMMAND_BAR.COMMANDS.GO_TO_AGENT_REPORTS",featureFlag:L.REPORTS,icon:Dt,path:t=>`accounts/${t}/reports/agent`,role:["administrator"]},{id:"open_label_reports",section:"COMMAND_BAR.SECTIONS.REPORTS",title:"COMMAND_BAR.COMMANDS.GO_TO_LABEL_REPORTS",featureFlag:L.REPORTS,icon:Bi,path:t=>`accounts/${t}/reports/label`,role:["administrator"]},{id:"open_inbox_reports",section:"COMMAND_BAR.SECTIONS.REPORTS",title:"COMMAND_BAR.COMMANDS.GO_TO_INBOX_REPORTS",featureFlag:L.REPORTS,icon:Hi,path:t=>`accounts/${t}/reports/inboxes`,role:["administrator"]},{id:"open_team_reports",section:"COMMAND_BAR.SECTIONS.REPORTS",title:"COMMAND_BAR.COMMANDS.GO_TO_TEAM_REPORTS",featureFlag:L.REPORTS,icon:Bt,path:t=>`accounts/${t}/reports/teams`,role:["administrator"]},{id:"open_agent_settings",section:"COMMAND_BAR.SECTIONS.SETTINGS",title:"COMMAND_BAR.COMMANDS.GO_TO_SETTINGS_AGENTS",featureFlag:L.AGENT_MANAGEMENT,icon:Dt,path:t=>`accounts/${t}/settings/agents/list`,role:["administrator"]},{id:"open_team_settings",title:"COMMAND_BAR.COMMANDS.GO_TO_SETTINGS_TEAMS",featureFlag:L.TEAM_MANAGEMENT,section:"COMMAND_BAR.SECTIONS.SETTINGS",icon:Bt,path:t=>`accounts/${t}/settings/teams/list`,role:["administrator"]},{id:"open_inbox_settings",title:"COMMAND_BAR.COMMANDS.GO_TO_SETTINGS_INBOXES",featureFlag:L.INBOX_MANAGEMENT,section:"COMMAND_BAR.SECTIONS.SETTINGS",icon:Gi,path:t=>`accounts/${t}/settings/inboxes/list`,role:["administrator"]},{id:"open_label_settings",title:"COMMAND_BAR.COMMANDS.GO_TO_SETTINGS_LABELS",featureFlag:L.LABELS,section:"COMMAND_BAR.SECTIONS.SETTINGS",icon:Ui,path:t=>`accounts/${t}/settings/labels/list`,role:["administrator"]},{id:"open_canned_response_settings",title:"COMMAND_BAR.COMMANDS.GO_TO_SETTINGS_CANNED_RESPONSES",featureFlag:L.CANNED_RESPONSES,section:"COMMAND_BAR.SECTIONS.SETTINGS",icon:Vi,path:t=>`accounts/${t}/settings/canned-response/list`,role:["administrator","agent"]},{id:"open_applications_settings",title:"COMMAND_BAR.COMMANDS.GO_TO_SETTINGS_APPLICATIONS",featureFlag:L.INTEGRATIONS,section:"COMMAND_BAR.SECTIONS.SETTINGS",icon:Ki,path:t=>`accounts/${t}/settings/applications`,role:["administrator"]},{id:"open_account_settings",title:"COMMAND_BAR.COMMANDS.GO_TO_SETTINGS_ACCOUNT",section:"COMMAND_BAR.SECTIONS.SETTINGS",icon:zi,path:t=>`accounts/${t}/settings/general`,role:["administrator"]},{id:"open_profile_settings",title:"COMMAND_BAR.COMMANDS.GO_TO_SETTINGS_PROFILE",section:"COMMAND_BAR.SECTIONS.SETTINGS",icon:Zi,path:t=>`accounts/${t}/profile/settings`,role:["administrator","agent"]},{id:"open_notifications",title:"COMMAND_BAR.COMMANDS.GO_TO_NOTIFICATIONS",section:"COMMAND_BAR.SECTIONS.SETTINGS",icon:Pi,path:t=>`accounts/${t}/notifications`,role:["administrator","agent"]}];function p1(){const{t}=se(),e=mn(),{isAdmin:n}=Nn(),i=Z("getCurrentAccountId"),o=Z("accounts/isFeatureEnabledonAccount"),s=l=>{e.push(Cn(l))};return{goToCommandHotKeys:O(()=>{let l=u1.filter(r=>r.featureFlag?o.value(i.value,r.featureFlag):!0);return n.value||(l=l.filter(r=>r.role.includes("agent"))),l.map(r=>({id:r.id,section:t(r.section),title:t(r.title),icon:r.icon,handler:()=>s(r.path(i.value))}))})}}const pn=U.SNOOZE_OPTIONS,v1=[{id:"resolve_conversation",title:"COMMAND_BAR.COMMANDS.RESOLVE_CONVERSATION",section:"COMMAND_BAR.SECTIONS.CONVERSATION",icon:un,handler:()=>P.emit(Sn)}],vn=(t,e,n)=>Object.values(pn).map(i=>({id:i,title:`COMMAND_BAR.COMMANDS.${i.toUpperCase()}`,parent:e,section:n,icon:xe,handler:()=>P.emit(t,i)})),Pt=[{id:"snooze_conversation",title:"COMMAND_BAR.COMMANDS.SNOOZE_CONVERSATION",section:"COMMAND_BAR.SECTIONS.CONVERSATION",icon:xe,children:Object.values(pn)},...vn(zt,"snooze_conversation","COMMAND_BAR.SECTIONS.SNOOZE_CONVERSATION")],f1=[{id:"reopen_conversation",title:"COMMAND_BAR.COMMANDS.REOPEN_CONVERSATION",section:"COMMAND_BAR.SECTIONS.CONVERSATION",icon:dn,handler:()=>P.emit(Mn)}],_1={id:"send_transcript",title:"COMMAND_BAR.COMMANDS.SEND_TRANSCRIPT",section:"COMMAND_BAR.SECTIONS.CONVERSATION",icon:xi,handler:()=>P.emit(Tn)},A1={id:"unmute_conversation",title:"COMMAND_BAR.COMMANDS.UNMUTE_CONVERSATION",section:"COMMAND_BAR.SECTIONS.CONVERSATION",icon:$i,handler:()=>P.emit(En)},O1={id:"mute_conversation",title:"COMMAND_BAR.COMMANDS.MUTE_CONVERSATION",section:"COMMAND_BAR.SECTIONS.CONVERSATION",icon:Ri,handler:()=>P.emit(wn)},g1=U.SNOOZE_OPTIONS,fn=t=>()=>P.emit(t),m1=[{id:"bulk_action_snooze_conversation",title:"COMMAND_BAR.COMMANDS.SNOOZE_CONVERSATION",section:"COMMAND_BAR.SECTIONS.BULK_ACTIONS",icon:xe,children:Object.values(g1)},...vn(Gt,"bulk_action_snooze_conversation","COMMAND_BAR.SECTIONS.BULK_ACTIONS")],N1=[{id:"bulk_action_reopen_conversation",title:"COMMAND_BAR.COMMANDS.REOPEN_CONVERSATION",section:"COMMAND_BAR.SECTIONS.BULK_ACTIONS",icon:dn,handler:fn(yn)}],C1=[{id:"bulk_action_resolve_conversation",title:"COMMAND_BAR.COMMANDS.RESOLVE_CONVERSATION",section:"COMMAND_BAR.SECTIONS.BULK_ACTIONS",icon:un,handler:fn(In)}];function S1(){const{t}=se(),e=Z("bulkActions/getSelectedConversationIds"),n=o=>o.map(s=>({...s,title:t(s.title),section:t(s.section)}));return{bulkActionsHotKeys:O(()=>{let o=[];return e.value.length>0&&(o=[...m1,...N1,...C1]),n(o)})}}const nt=(t,e)=>t.map(n=>({...n,title:e(n.title),section:e(n.section)})),M1=(t,e)=>[{label:t("CONVERSATION.PRIORITY.OPTIONS.NONE"),key:null,icon:qi},{label:t("CONVERSATION.PRIORITY.OPTIONS.URGENT"),key:"urgent",icon:Yi},{label:t("CONVERSATION.PRIORITY.OPTIONS.HIGH"),key:"high",icon:Wi},{label:t("CONVERSATION.PRIORITY.OPTIONS.MEDIUM"),key:"medium",icon:Xi},{label:t("CONVERSATION.PRIORITY.OPTIONS.LOW"),key:"low",icon:Ji}].filter(n=>n.key!==e),E1=(t,e)=>e===Ln.REPLY?[{label:t("INTEGRATION_SETTINGS.OPEN_AI.OPTIONS.REPLY_SUGGESTION"),key:"reply_suggestion",icon:de}]:[{label:t("INTEGRATION_SETTINGS.OPEN_AI.OPTIONS.SUMMARIZE"),key:"summarize",icon:Qi}],w1=t=>[{label:t("INTEGRATION_SETTINGS.OPEN_AI.OPTIONS.CONFIDENT"),key:"confident",icon:de},{label:t("INTEGRATION_SETTINGS.OPEN_AI.OPTIONS.FIX_SPELLING_GRAMMAR"),key:"fix_spelling_grammar",icon:n1},{label:t("INTEGRATION_SETTINGS.OPEN_AI.OPTIONS.PROFESSIONAL"),key:"professional",icon:e1},{label:t("INTEGRATION_SETTINGS.OPEN_AI.OPTIONS.CASUAL"),key:"casual",icon:t1},{label:t("INTEGRATION_SETTINGS.OPEN_AI.OPTIONS.MAKE_FRIENDLY"),key:"friendly",icon:de},{label:t("INTEGRATION_SETTINGS.OPEN_AI.OPTIONS.STRAIGHTFORWARD"),key:"straightforward",icon:de}];function T1(){const{t}=se(),e=Kt(),n=Zt(),{activeLabels:i,inactiveLabels:o,addLabelToConversation:s,removeLabelFromConversation:a}=bn(),{captainTasksEnabled:l}=Rn(),{agentsList:r}=$n(),c=Z("getSelectedChat"),d=Z("draftMessages/getReplyEditorMode"),p=Z("getContextMenuChatId"),h=Z("teams/getTeams"),v=Z("draftMessages/get"),u=O(()=>{var A;return(A=c.value)==null?void 0:A.id}),_=O(()=>`draft-${u.value}-${d.value}`),R=O(()=>v.value(_.value)),K=O(()=>{var A,f;return!!((f=(A=c.value)==null?void 0:A.meta)!=null&&f.team)}),F=O(()=>K.value?[{id:0,name:t("TEAMS_SETTINGS.LIST.NONE")},...h.value]:h.value),ge=A=>{e.dispatch("assignAgent",{conversationId:c.value.id,agentId:A.agentInfo.id})},Le=A=>{e.dispatch("assignPriority",{conversationId:c.value.id,priority:A.priority.key})},je=A=>{e.dispatch("assignTeam",{conversationId:c.value.id,teamId:A.teamInfo.id})},ke=O(()=>{var ut,pt,vt;const A=((ut=c.value)==null?void 0:ut.status)===U.STATUS_TYPE.OPEN,f=((pt=c.value)==null?void 0:pt.status)===U.STATUS_TYPE.SNOOZED,x=((vt=c.value)==null?void 0:vt.status)===U.STATUS_TYPE.RESOLVED;let Ze=[];return A?Ze=[...v1,...Pt]:(x||f)&&(Ze=f1),nt(Ze,t)}),De=O(()=>{var A;return M1(t,(A=c.value)==null?void 0:A.priority)}),me=O(()=>{const A=r.value.map(f=>({id:`agent-${f.id}`,title:f.name,parent:"assign_an_agent",section:t("COMMAND_BAR.SECTIONS.CHANGE_ASSIGNEE"),agentInfo:f,icon:jt,handler:ge}));return[{id:"assign_an_agent",title:t("COMMAND_BAR.COMMANDS.ASSIGN_AN_AGENT"),section:t("COMMAND_BAR.SECTIONS.CONVERSATION"),icon:jt,children:A.map(f=>f.id)},...A]}),Be=O(()=>{const A=De.value.map(f=>({id:`priority-${f.key}`,title:f.label,parent:"assign_priority",section:t("COMMAND_BAR.SECTIONS.CHANGE_PRIORITY"),priority:f,icon:f.icon,handler:Le}));return[{id:"assign_priority",title:t("COMMAND_BAR.COMMANDS.ASSIGN_PRIORITY"),section:t("COMMAND_BAR.SECTIONS.CONVERSATION"),icon:Fi,children:A.map(f=>f.id)},...A]}),He=O(()=>{const A=F.value.map(f=>({id:`team-${f.id}`,title:f.name,parent:"assign_a_team",section:t("COMMAND_BAR.SECTIONS.CHANGE_TEAM"),teamInfo:f,icon:Ht,handler:je}));return[{id:"assign_a_team",title:t("COMMAND_BAR.COMMANDS.ASSIGN_A_TEAM"),section:t("COMMAND_BAR.SECTIONS.CONVERSATION"),icon:Ht,children:A.map(f=>f.id)},...A]}),Ne=O(()=>[...o.value.map(f=>({id:f.title,title:`#${f.title}`,parent:"add_a_label_to_the_conversation",section:t("COMMAND_BAR.SECTIONS.ADD_LABEL"),icon:Lt,handler:x=>s({title:x.id})})),{id:"add_a_label_to_the_conversation",title:t("COMMAND_BAR.COMMANDS.ADD_LABELS_TO_CONVERSATION"),section:t("COMMAND_BAR.SECTIONS.CONVERSATION"),icon:Lt,children:o.value.map(f=>f.title)}]),Pe=O(()=>[...i.value.map(f=>({id:f.title,title:`#${f.title}`,parent:"remove_a_label_to_the_conversation",section:t("COMMAND_BAR.SECTIONS.REMOVE_LABEL"),icon:kt,handler:x=>a(x.id)})),{id:"remove_a_label_to_the_conversation",title:t("COMMAND_BAR.COMMANDS.REMOVE_LABEL_FROM_CONVERSATION"),section:t("COMMAND_BAR.SECTIONS.CONVERSATION"),icon:kt,children:i.value.map(f=>f.title)}]),g=O(()=>i.value.length?[...Ne.value,...Pe.value]:Ne.value),I=O(()=>nt([c.value.muted?A1:O1,_1],t)),$=O(()=>{const f=(R.value?w1(t):E1(t,d.value)).map(x=>({id:`ai-assist-${x.key}`,title:x.label,parent:"ai_assist",section:t("COMMAND_BAR.SECTIONS.AI_ASSIST"),priority:x,icon:x.icon,handler:()=>P.emit(xn,x.key)}));return[{id:"ai_assist",title:t("COMMAND_BAR.COMMANDS.AI_ASSIST"),section:t("COMMAND_BAR.SECTIONS.AI_ASSIST"),icon:de,children:f.map(x=>x.id)},...f]}),b=O(()=>ft(n.name)||Vt(n.name)),k=O(()=>ft(n.name,!0,!1)&&p.value),D=O(()=>{const A=[...ke.value,...I.value,...me.value,...He.value,...g.value,...Be.value];return l.value?[...A,...$.value]:A});return{conversationHotKeys:O(()=>k.value?nt(Pt,t):b.value?D.value:[])}}const y1="dynamic_snooze_",H1={__name:"commandbar",setup(t){const e=Kt(),{t:n,tm:i}=se(),{resolvedLocale:o}=jn(),s=Ce(null),a=Ce(null),{goToAppearanceHotKeys:l}=c1(),{inboxHotKeys:r}=d1(),{goToCommandHotKeys:c}=p1(),{bulkActionsHotKeys:d}=S1(),{conversationHotKeys:p}=T1(),h=["snooze_conversation","snooze_notification","bulk_action_snooze_conversation"],v=U.SNOOZE_OPTIONS.UNTIL_CUSTOM_TIME,u=Ce([]),_=Ce(null),R=O(()=>h.includes(_.value)?n("COMMAND_BAR.SNOOZE_PLACEHOLDER"):n("COMMAND_BAR.SEARCH_PLACEHOLDER")),K=new Set(Object.values(U.SNOOZE_OPTIONS)),F=O(()=>{const g=[...u.value,...r.value,...c.value,...l.value,...d.value,...p.value];return u.value.length?g.filter(I=>!K.has(I.id)||!h.includes(I.parent)):g}),ge=()=>{s.value.data=F.value},Le={snooze_conversation:zt,snooze_notification:Ut,bulk_action_snooze_conversation:Gt},je={snooze_conversation:"COMMAND_BAR.SECTIONS.SNOOZE_CONVERSATION",snooze_notification:"COMMAND_BAR.SECTIONS.SNOOZE_NOTIFICATION",bulk_action_snooze_conversation:"COMMAND_BAR.SECTIONS.BULK_ACTIONS"},ke=O(()=>{const g=i("SNOOZE_PARSER");return!g||typeof g!="object"?{}:JSON.parse(JSON.stringify(g))}),De=(g,I)=>{const $=Vn(g,new Date,{translations:ke.value,locale:o.value});if(!$.length)return[];const b=Le[I],k=n(je[I]);return $.map((D,dt)=>({id:`${y1}${dt}`,title:D.label!==D.formattedDate?`${D.label} - ${D.formattedDate}`:D.formattedDate,parent:I,section:k,icon:xe,keywords:g,handler:()=>{P.emit(b,D.resolve()),_t(Un.NLP_SNOOZE_APPLIED,{label:D.label})}}))},me=()=>{_.value=null,u.value=[]},Be=g=>{if(!g||typeof g.open!="function"||typeof g.close!="function")return;const I=g.open.bind(g),$=g.close.bind(g);g.open=(...b)=>{const[k={}]=b;return _.value=k.parent||null,u.value=[],I(...b)},g.close=(...b)=>(me(),$(...b))},He=g=>{const{detail:{action:{title:I=null,section:$=null,id:b=null,children:k=null}={}}={}}=g;a.value=b===v?b:null,Array.isArray(k)&&k.length&&(_.value=b),_t(Zn.COMMAND_BAR,{section:$,action:I}),ge()},Ne=g=>{const{detail:{search:I="",actions:$=[]}={}}=g,b=I.trim();if($.length>0){const k=[...new Set($.map(D=>D.parent).filter(Boolean))];k.length===1?_.value=k[0]:_.value=null}if(!b||!h.includes(_.value||"")){u.value=[];return}u.value=De(b,_.value)},Pe=()=>{a.value!==v&&e.dispatch("setContextMenuChatId",null),me()};return kn(()=>{s.value&&(s.value.data=F.value)}),Dn(()=>{ge(),Be(s.value)}),(g,I)=>{const $=Bn("ninja-keys");return Hn(),Pn($,{ref_key:"ninjakeys",ref:s,noAutoLoadMdIcons:"",hideBreadcrumbs:"",placeholder:R.value,onChange:Ne,onSelected:He,onClosed:Pe},null,8,["placeholder"])}}};export{H1 as default};
